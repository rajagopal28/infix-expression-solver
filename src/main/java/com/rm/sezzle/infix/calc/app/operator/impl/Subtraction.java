...
/**
 * Subtraction class implements the difference operation.<br/>
...
public class Subtraction extends Operator {
     ...
     */
    public Subtraction() {
        super(CalculatorAppConstants.SUB_OPERATOR, CalculatorAppConstants.ADD_SUB_PRIORITY_ONE);
    }

    /**
     * Execute methods applies the Difference operation on the operands passed.
     *
     * @param first  Operand involved in the Operation
     * @param second Operand involved in the Operation
     * @return Operand resulting in the difference of the given 2 Operands
     */
    @Override
