...
/**
 * Multiplication class implements the product operation.<br/>
...
public class Multiplication extends Operator {
    ...
    /**
     * Execute methods applies the Multiplication operation on the operands passed.
     *
     * @param first  Operand involved in the Operation
     * @param second Operand involved in the Operation
     * @return Operand resulting in the product of the given 2 Operands
     */
    @Override
